...
RSpec.describe CategoryPolicy do
  ...
  let(:category) { create(:category, container: container) }
  ...
  shared_examples 'catalog manage permissions' do |action|
    ...
    context 'for a Collection Administrator of the category collection' do
    ...
    context 'for a Collection Manager of the category collection' do
      let(:user) { create(:user) }
