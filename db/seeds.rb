...
unless Rails.env.production? || ENV['SKIP_SEEDS']
  ...
  EditableContent.create([
                          ...
                          { page: "judging_assignments", section: "session_timeout_guidance",
                            content: ActionText::RichText.new(body: "<p><strong>Judge session timeout:</strong> Judges are signed out after 2 hours of inactivity in LSA Evaluate.</p>") },
                          { page: "judge_dashboard", section: "session_timeout_guidance",
                            content: ActionText::RichText.new(body: "<p>Your session expires after <strong>2 hours of inactivity</strong>.</p>") },
